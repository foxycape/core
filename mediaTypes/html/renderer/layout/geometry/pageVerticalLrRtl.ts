...
export const pageVerticalLrRtl: ILayoutGeometry = {
    id: "page-vertical-lr-rtl",
    writingMode: "vertical-lr",
    direction: "rtl",
    flipMode: "page",
    rootClass: "dir-rtl",
    rendererClass: "layout-page-vertical-lr-rtl",
    contentClass: "content-page-vertical-lr-rtl",
    blockAxis: "x",
    blockSign: 1,
    pageAxis: "y",
    pageSign: 1,
    ...
    getPageTransformOffset: (box, pageNumber, pageMoveLength) => {
        ...
        const startOffset = pageVerticalLrRtl.getPageStartOffset(box);
